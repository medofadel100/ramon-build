...
export const DEFAULT_CONSTANTS: ConstantDefinition[] = [
  ...
  { key: 'price_kitchen_granite_double_black', label: 'سعر متر جرانيت دبل بلاك', group: 'materials', subgroup: 'kitchens', defaultValue: 2200, unit: 'ج.م' },
  { key: 'price_kitchen_granite_indian', label: 'سعر متر جرانيت أخضر هندي', group: 'materials', subgroup: 'kitchens', defaultValue: 2500, unit: 'ج.م' },
  ...
  { key: 'price_kitchen_board_hpl', label: 'سعر متر مطابخ HPL', group: 'materials', subgroup: 'kitchens', defaultValue: 3500, unit: 'ج.م' },
  { key: 'price_kitchen_board_acrylic', label: 'سعر متر مطابخ أكريليك', group: 'materials', subgroup: 'kitchens', defaultValue: 4200, unit: 'ج.م' },
  { key: 'price_kitchen_board_polylac', label: 'سعر متر مطابخ بولي لاك', group: 'materials', subgroup: 'kitchens', defaultValue: 4800, unit: 'ج.م' },
  { key: 'price_kitchen_board_uv', label: 'سعر متر مطابخ UV', group: 'materials', subgroup: 'kitchens', defaultValue: 3200, unit: 'ج.م' },
  { key: 'price_kitchen_alumital', label: 'سعر متر مطابخ ألوميتال', group: 'materials', subgroup: 'kitchens', defaultValue: 2800, unit: 'ج.م' },
  { key: 'price_kitchen_khashmonium', label: 'سعر متر مطابخ خشمونيوم', group: 'materials', subgroup: 'kitchens', defaultValue: 3300, unit: 'ج.م' },
  { key: 'price_kitchen_natural_wood', label: 'سعر متر مطابخ خشب طبيعي (أرو/زان)', group: 'materials', subgroup: 'kitchens', defaultValue: 6500, unit: 'ج.م' },
  { key: 'price_kitchen_hinge_blum', label: 'سعر مفصلة بلوم Blum سوفت كلوز', group: 'materials', subgroup: 'kitchens', defaultValue: 150, unit: 'ج.م' },
  { key: 'price_kitchen_hinge_hettich', label: 'سعر مفصلة هيتيش Hettich', group: 'materials', subgroup: 'kitchens', defaultValue: 130, unit: 'ج.م' },
  { key: 'price_kitchen_hinge_normal', label: 'سعر مفصلة عادية/صيني', group: 'materials', subgroup: 'kitchens', defaultValue: 45, unit: 'ج.م' },
  { key: 'price_kitchen_drawer_soft', label: 'مجرى درج سوفت كلوز (طقم)', group: 'materials', subgroup: 'kitchens', defaultValue: 350, unit: 'ج.م' },
  ...
  { key: 'price_wpc_panel', label: 'سعر شريحة بديل الخشب WPC (12 سم)', group: 'materials', subgroup: 'cladding', defaultValue: 450, unit: 'ج.م' },
  { key: 'price_wpc_panel_large', label: 'سعر شريحة بديل الخشب WPC (20 سم)', group: 'materials', subgroup: 'cladding', defaultValue: 650, unit: 'ج.م' },
  { key: 'price_acoustic_panel', label: 'سعر شريحة أكوستيك بانل (عازل صوت)', group: 'materials', subgroup: 'cladding', defaultValue: 850, unit: 'ج.م' },
  { key: 'price_pvc_marble_panel', label: 'سعر لوح بديل الرخام PVC (1.2x2.4م)', group: 'materials', subgroup: 'cladding', defaultValue: 1200, unit: 'ج.م' },
  { key: 'price_pvc_marble_uv', label: 'سعر لوح بديل الرخام UV مضيء', group: 'materials', subgroup: 'cladding', defaultValue: 1800, unit: 'ج.م' },
  { key: 'price_mdf_veneer_panel', label: 'سعر لوح تجليد خشب قشرة أرو', group: 'materials', subgroup: 'cladding', defaultValue: 2500, unit: 'ج.م' },
  { key: 'price_mdf_cnc_panel', label: 'سعر متر خشب CNC مفرغ ديكور', group: 'materials', subgroup: 'cladding', defaultValue: 1500, unit: 'ج.م' },
  { key: 'price_wall_foam_3d', label: 'سعر بلاطة فوم 3D حوائط', group: 'materials', subgroup: 'cladding', defaultValue: 80, unit: 'ج.م' },
  { key: 'price_cladding_adhesive', label: 'سعر عبوة سيليكون عظم (للتثبيت)', group: 'materials', subgroup: 'cladding', defaultValue: 180, unit: 'ج.م' },
  { key: 'price_cladding_metal_trim', label: 'سعر عود ستانلس ستيل ديكور (حرف T/U)', group: 'materials', subgroup: 'cladding', defaultValue: 120, unit: 'ج.م' },
  ...
  { key: 'price_switch_panasonic', label: 'لقمة مفتاح باناسونيك', group: 'materials', subgroup: 'electrical_switches', defaultValue: 45, unit: 'ج.م' },
  { key: 'price_switch_sanches', label: 'لقمة مفتاح سانشس', group: 'materials', subgroup: 'electrical_switches', defaultValue: 35, unit: 'ج.م' },
  ...
  { key: 'price_socket_panasonic', label: 'بريزة باناسونيك', group: 'materials', subgroup: 'electrical_switches', defaultValue: 60, unit: 'ج.م' },
  ...
  { key: 'price_plate_panasonic', label: 'وش باناسونيك', group: 'materials', subgroup: 'electrical_switches', defaultValue: 35, unit: 'ج.م' },
  ...
  { key: 'price_keystone_rj45', label: 'لقمة إنترنت RJ45', group: 'materials', subgroup: 'electrical_switches', defaultValue: 80, unit: 'ج.م' },
  { key: 'price_socket_usb', label: 'بريزة USB للشحن', group: 'materials', subgroup: 'electrical_switches', defaultValue: 250, unit: 'ج.م' },
  { key: 'price_socket_tv', label: 'لقمة دش TV', group: 'materials', subgroup: 'electrical_switches', defaultValue: 70, unit: 'ج.م' },
  ...
  { key: 'price_spot_anti_glare', label: 'سبوت Anti-glare (مانع للتوهج)', group: 'materials', subgroup: 'electrical_lighting', defaultValue: 350, unit: 'ج.م' },
  ...
  { key: 'price_magnetic_track_m', label: 'مجرى ماجنيتيك تراك (متر طول)', group: 'materials', subgroup: 'electrical_lighting', defaultValue: 850, unit: 'ج.م' },
  { key: 'price_magnetic_spot', label: 'سبوت ماجنيتيك تراك', group: 'materials', subgroup: 'electrical_lighting', defaultValue: 650, unit: 'ج.م' },
  { key: 'price_led_profile_m', label: 'قطاع ألومنيوم بروفايل كامل بالليد (متر)', group: 'materials', subgroup: 'electrical_lighting', defaultValue: 450, unit: 'ج.م' },
  { key: 'price_led_strip_m', label: 'شريط ليد COB كثافة عالية (متر)', group: 'materials', subgroup: 'electrical_lighting', defaultValue: 65, unit: 'ج.م' },
  ...
  { key: 'price_chandelier_modern', label: 'نجفة مودرن ليد', group: 'materials', subgroup: 'electrical_lighting', defaultValue: 3500, unit: 'ج.م' },
  ...
  { key: 'price_applique_indoor', label: 'أبليك/أباجورة حائط داخلي', group: 'materials', subgroup: 'electrical_lighting', defaultValue: 450, unit: 'ج.م' },
  { key: 'price_applique_outdoor', label: 'أبليك سور خارجي (واتر بروف)', group: 'materials', subgroup: 'electrical_lighting', defaultValue: 650, unit: 'ج.م' },
  { key: 'price_driver_meanwell', label: 'محول ترانس Mean Well أصلي', group: 'materials', subgroup: 'electrical_lighting', defaultValue: 350, unit: 'ج.م' },
  { key: 'price_driver_chinese', label: 'محول ترانس صيني تجاري', group: 'materials', subgroup: 'electrical_lighting', defaultValue: 150, unit: 'ج.م' },

  // Plumbing Finishes (التشطيبات الصحية والخلاطات)
  { key: 'price_wc_duravit', label: 'سعر طقم حمام ديورافيت Duravit', group: 'materials', subgroup: 'sanitary', defaultValue: 6500, unit: 'ج.م' },
  { key: 'price_wc_ideal', label: 'سعر طقم حمام إيديال ستاندرد', group: 'materials', subgroup: 'sanitary', defaultValue: 7200, unit: 'ج.م' },
  { key: 'price_wc_roca', label: 'سعر طقم حمام روكا Roca', group: 'materials', subgroup: 'sanitary', defaultValue: 8500, unit: 'ج.م' },
  { key: 'price_wc_gravena', label: 'سعر طقم حمام جرافينا', group: 'materials', subgroup: 'sanitary', defaultValue: 4500, unit: 'ج.م' },
  { key: 'price_wc_geberit', label: 'سعر صندوق طرد مدفون (جروهي/جبريت)', group: 'materials', subgroup: 'sanitary', defaultValue: 4800, unit: 'ج.م' },
  { key: 'price_wc_wall_hung', label: 'سعر قاعدة معلقة (بدون الصندوق)', group: 'materials', subgroup: 'sanitary', defaultValue: 5500, unit: 'ج.م' },
  { key: 'price_mixer_grohe', label: 'سعر طقم خلاطات جروهي Grohe (3 قطع)', group: 'materials', subgroup: 'sanitary', defaultValue: 14000, unit: 'ج.م' },
  { key: 'price_mixer_hansgrohe', label: 'سعر طقم خلاطات هانز جروهي Hansgrohe', group: 'materials', subgroup: 'sanitary', defaultValue: 18000, unit: 'ج.م' },
  { key: 'price_mixer_ideal', label: 'سعر طقم خلاطات إيديال (3 قطع)', group: 'materials', subgroup: 'sanitary', defaultValue: 8500, unit: 'ج.م' },
  { key: 'price_mixer_fiore', label: 'سعر طقم خلاطات فيوري Fiore إيطالي', group: 'materials', subgroup: 'sanitary', defaultValue: 11000, unit: 'ج.م' },
  { key: 'price_mixer_turk', label: 'سعر طقم خلاطات تركي (3 قطع)', group: 'materials', subgroup: 'sanitary', defaultValue: 4500, unit: 'ج.م' },
  { key: 'price_mixer_gold_black', label: 'سعر طقم خلاطات ديكور (ذهبي/أسود مط)', group: 'materials', subgroup: 'sanitary', defaultValue: 12500, unit: 'ج.م' },
  { key: 'price_shower_column', label: 'سعر عامود دش (مسطرة دش)', group: 'materials', subgroup: 'sanitary', defaultValue: 2500, unit: 'ج.م' },
  { key: 'price_bathroom_accessories', label: 'طقم إكسسوارات حمام (فواطة/صبانة...)', group: 'materials', subgroup: 'sanitary', defaultValue: 1800, unit: 'ج.م' },
  // =====================
