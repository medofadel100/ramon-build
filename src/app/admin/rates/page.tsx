              ...
              <div className="flex-1">
                ...
                {c.group === 'rates' && (
                  <div className="mt-2 flex items-center gap-2">
                    ...
                    <span className="text-xs text-slate-400">معدل استهلاك / نسبة هدر</span>
                  </div>
                )}
              </div>
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 py-8 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#13151c] p-5 rounded-xl border border-[#222634]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">المعدلات الهندسية ونسب الهدر</h1>
              <p className="text-xs text-slate-400 mt-0.5">القاعدة المركزية للمعدلات التي تستخدم في الحصر التلقائي وطلبيات الخامات.</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in">
          <div className="bg-[#13151c] border border-[#222634] rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
            <div className="flex items-center justify-between p-5 border-b border-[#222634] bg-[#1a1c24]">
              <h3 className="text-lg font-bold text-white">إضافة معدل جديد أو نسبة هدر</h3>
              <button 
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className="block text-xs font-bold text-slate-400 mb-2">اسم المعدل أو النسبة</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-bold text-slate-400 mb-2">القيمة الافتراضية</label>
                <input
                  type="number"
